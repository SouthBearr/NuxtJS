<script setup></script>
<template>
  <div class="bg-emerald-300 p-3 flex justify-between items-center">
    <div>
      <svg
        class="w-[80px] h-[80px]"
        ...
        <metadata>
          <rdf:RDF>
            <cc:Work>
              ...
              <dc:description
                >A cat paw print (sharp version), based on a photo I took of my
                cat's paw prints in the snow. Drawn in Inkscape.</dc:description
              >
              <dc:source
                >https://openclipart.org/detail/58735/cat-paw-print-by-j_alves</dc:source
              >
              <dc:creator>
                <cc:Agent>
